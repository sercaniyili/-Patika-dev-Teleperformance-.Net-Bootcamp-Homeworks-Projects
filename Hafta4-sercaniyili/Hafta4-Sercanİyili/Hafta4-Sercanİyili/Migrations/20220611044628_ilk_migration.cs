...
namespace Hafta4_Sercanİyili.Migrations
{
    public partial class ilk_migration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FriendshipsApprovements", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupMessageHistories", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserMessageHistories", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Posts_AspNetUsers_Sender",
                        column: x => x.Sender,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserMessages_AspNetUsers_Reciever",
                        column: x => x.Reciever,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserMessages_AspNetUsers_Sender",
                        column: x => x.Sender,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Friendships_AspNetUsers_Reciever",
                        column: x => x.Reciever,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Friendships_AspNetUsers_Sender",
                        column: x => x.Sender,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    GroupMemberId1 = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Memberships_AspNetUsers_GroupMemberId1",
                        column: x => x.GroupMemberId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_AspNetUsers_Sender",
                        column: x => x.Sender,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Friendships_Reciever",
                table: "Friendships",
                column: "Reciever");

            migrationBuilder.CreateIndex(
                name: "IX_Friendships_Sender",
                table: "Friendships",
                column: "Sender");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupMessages_Reciever",
                table: "GroupMessages",
                column: "Reciever");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Memberships_GroupMemberId1",
                table: "Memberships",
                column: "GroupMemberId1");

            migrationBuilder.CreateIndex(
                name: "IX_Posts_Sender",
                table: "Posts",
                column: "Sender");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserMessages_Reciever",
                table: "UserMessages",
                column: "Reciever");

            migrationBuilder.CreateIndex(
                name: "IX_UserMessages_Sender",
                table: "UserMessages",
                column: "Sender");

            migrationBuilder.CreateIndex(
                name: "IX_UserMessages_TypeId",
                table: "UserMessages",
                column: "TypeId");
        }
